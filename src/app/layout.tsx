...
const routeTitles: Record<string, string> = {
  '/': 'DRAIS — Finally Know Who Is In School, In Real Time',
  '/features': 'Features — DRAIS School Management System',
  '/attendance': 'Attendance System — DRAIS',
  '/attendance-demo': 'Attendance Demo — DRAIS',
  '/pricing': 'Pricing — DRAIS',
  '/demo': 'See DRAIS In Action — Live Demo',
  '/screenshots': 'Screenshots — DRAIS',
  '/documentation': 'Documentation — DRAIS',
  '/about': 'About — DRAIS by Xhenvolt',
  '/contact': 'Contact Us — DRAIS',
